...
async def main():
    ...
    print()
    print("📋 TWO-WALLET ARCHITECTURE:")
    print()
    print("1. Browser Wallet (Owner) - YOU")
    print("   - Deploys contracts")
    print("   - Grants/revokes roles")
    print("   - Emergency controls")
    print("   - Use rarely - keep offline when possible")
    print()
    print("2. Server Wallet (Notary) - HOT WALLET")
    print("   - Signs ALL user transactions")
    print("   - Pays all gas fees (gasless service)")
    print("   - Runs 24/7 on server")
    print("   - Users identified by metadata, not wallet")
    print()
    print("Next steps:")
    ...
    print("- Keep your browser wallet private key secure (cold storage)")
    print("- You are the contract owner - only you can authorize notaries")
    print("- Consider using a multisig wallet (Gnosis Safe) for production")
    print("- Server wallet is hot - monitor balance and activity closely")
    print("=" * 80)
